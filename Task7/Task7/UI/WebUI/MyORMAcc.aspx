<%@ Page Title="MyORM" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="Panel2" runat="server" Height="140px" Width="284px">
    ...
    <asp:Panel ID="Panel3" runat="server" Height="90px" Width="284px">
        ...
        <br />
        <a:CaptchaControl ID="captcha2" runat="server" />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="PnlMessage" runat="server" Height="28px" Width="357px">
