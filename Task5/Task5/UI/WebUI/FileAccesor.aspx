<%@ Page Title="File" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="FileAccesor.aspx.cs" Inherits="WebUI.FileAccesor" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="Panel2" runat="server" Height="75px" Width="217px">
